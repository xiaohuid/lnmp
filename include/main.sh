...
DB_Info=('MySQL 5.1.73' 'MySQL 5.5.58' 'MySQL 5.6.39' 'MySQL 5.7.21' 'MariaDB 5.5.58' 'MariaDB 10.0.33' 'MariaDB 10.1.30' 'MariaDB 10.2.11')
...
#which MySQL Version do you want to install?
    ...
    *)
    ...
    if [[ "${DBSelect}" =~ ^[34678]$ ]] && [ `free -m | grep Mem | awk '{print  $2}'` -le 512 ]; then
        echo "Memory less than 512MB, can't install MySQL 5.6, 5.7 or MairaDB 10+!"
        exit 1
    fi
